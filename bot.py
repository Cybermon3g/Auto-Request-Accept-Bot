...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("Supoort", url="https://t.me/Spideysupport")
      ],[
      InlineKeyboardButton("𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴", url=f"https://youtube.com/channel/UCf_dVNrilcT0V2R--HbYpMA")
      ]]
    await message.reply_text(text="HELLO...⚡\nIAM A SIMPLE TELEGRAM AUTO REQUEST ACCEPT BOT.", reply_markup=InlineKeyboardMarkup(button), disable_web_page_preview=True)
